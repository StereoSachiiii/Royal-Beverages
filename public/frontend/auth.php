                ...
                <div id="loginContainer" class="auth-module auth-transition opacity-100 block">
                    ...
                    <form id="loginForm" class="space-y-6">
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            ...
                            <span class="text-[9px] uppercase font-bold tracking-widest text-gray-400">Or continue with</span>
                            <span class="w-1/5 border-b border-gray-200"></span>
                        </div>
                        
                        <a href="/api/v1/oauth/google/redirect" class="w-full h-14 bg-white border border-gray-200 flex items-center justify-center gap-3 text-[10px] uppercase font-black tracking-[0.2em] text-black hover:bg-gray-50 transition-all duration-500 mt-4">
