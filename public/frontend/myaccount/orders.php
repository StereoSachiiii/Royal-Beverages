        ...
        const itemsHtml = (order.items || []).map(item => `
            <div class="flex gap-6 py-4 border-b border-gray-50 last:border-0 items-center">
                <div class="w-16 h-16 bg-gray-50 flex-shrink-0 border border-gray-100 overflow-hidden">
                    <img src="${fixImagePath(item.product_image_url)}" class="w-full h-full object-contain grayscale hover:grayscale-0 transition-all duration-300" onerror="this.src='<?= BASE_URL ?>assets/images/placeholder-product.webp'">
                </div>
                <div class="flex-grow">
