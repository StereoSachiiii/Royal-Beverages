    ...
    <section id="productShowcase" class="px-8 md:px-16 py-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div class="relative bg-gray-50 flex items-center justify-center p-8 lg:p-12 h-[350px] lg:h-[450px] group overflow-hidden">
                ...
                <img id="mainImage" src="" alt="" class="w-full h-full object-contain transition-transform duration-1000 group-hover:scale-105 z-10" onerror="this.src='<?= BASE_URL ?>assets/images/placeholder-product.webp'">
...
import { fixImagePath, showErrorBoundary } from '<?= BASE_URL ?>assets/js/ui-components.js';
...
const init = async () => {
    try {
        ...
        // Load only a handful of other products for related section
        const allRes = await API.request('/products/enriched/all' + API.buildQuery({ limit: 5 }));
        ...
        showErrorBoundary("We couldn't load this product right now. Please return home and try again.");
    }
};
