...
const initCartSlideIn = () => {
  ...
  if (!document.getElementById('cartSlideIn')) {
    ...
    slideIn.style.cssText =
      'position: fixed; top: 100px; right: -450px; width: 420px; max-width: 100vw; background: white; z-index: 9999; transition: right 0.5s cubic-bezier(0.4, 0, 0.2, 1); display: flex; flex-direction: column; box-shadow: -10px 0 40px rgba(0,0,0,0.15);';
